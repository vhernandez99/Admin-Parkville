    ...
    public static class ApiService
    {
        ...
        public static async Task<bool> AddMovie(MediaFile mediaFile, Movie movie)
        {
            ...
            var content = new MultipartFormDataContent
            {
                ...
                {new StringContent(movie.PlayingDate2),"PlayingDate2" },
                {new StringContent(movie.PlayingDate3),"PlayingDate3" },
                {new StringContent(movie.PlayingDate4),"PlayingDate4" },
                {new StringContent(movie.PlayingDate5),"PlayingDate5" },
                {new StringContent(movie.PlayingTime),"PlayingTime" },
                {new StringContent(movie.PlayingTime2),"PlayingTime2" },
                {new StringContent(movie.PlayingTime3),"PlayingTime3" },
                {new StringContent(movie.PlayingTime4),"PlayingTime4" },
                {new StringContent(movie.PlayingTime5),"PlayingTime5" },
